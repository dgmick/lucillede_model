...
<ul class="tribe-related-events tribe-clearfix hfeed vcalendar clearfix">
	...
	<li>
		<?php $thumb = (has_post_thumbnail($post->ID)) ? get_the_post_thumbnail($post->ID, 'cmsmasters-event-thumb') : '<span class="cmsmasters_events_img_placeholder cmsmasters_theme_icon_image"></span>'; ?>
