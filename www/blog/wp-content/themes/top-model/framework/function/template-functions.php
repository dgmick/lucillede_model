				...
				'<div class="mid_nav_wrap">' . 
					'<nav >';
						...
						$nav_args = array( 
							...
							'link_before' => 		'<span class="nav_item_wrap">', 
							'link_after' => 		'</span>', 
							'fallback_cb' => 		'top_model_fallback_menu' 
						);
...
function top_model_logo() {
	...
	if ($cmsmasters_option['top-model' . '_logo_type'] == 'text') {
		if ($cmsmasters_option['top-model' . '_logo_title'] != '') {
			$blog_title = $cmsmasters_option['top-model' . '_logo_title'];
		} else {
		...
		if ($cmsmasters_option['top-model' . '_logo_subtitle'] != '') {
			$blog_descr = $cmsmasters_option['top-model' . '_logo_subtitle'];
		} else {
...
function top_model_sharing_box($title_box = false, $tag = 'h3') {
	...
	echo "<aside class=\"share_posts\">
		...
		<div class=\"share_posts_inner\">
			...
			<a href=\"https://plus.google.com/share?url={$page_link}\">" . esc_html__('Google+', 'top-model') . "</a>
