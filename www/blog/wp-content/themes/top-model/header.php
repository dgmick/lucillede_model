...
<div id="page" class="<?php top_model_get_page_classes($cmsmasters_option); ?>hfeed site">
...
<header id="header"<?php 
	if ($cmsmasters_option['top-model' . '_header_styles'] == 'fullwidth') {
		echo ' class="header_fullwidth"';
	}
?>>
	<?php 
	top_model_header_top($cmsmasters_option);
	
	
	top_model_header_mid($cmsmasters_option);
	
	
	top_model_header_bot($cmsmasters_option);
	?>
</header>
...
list($cmsmasters_layout, $cmsmasters_page_scheme) = top_model_theme_page_layout_scheme();
